    ...
    public class GradoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Grado != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Grado1'  is null.");
        }

        // GET: Grado1/Details/5
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var grado = await _context.Grado
                .FirstOrDefaultAsync(m => m.GradoId == id);
            if (grado == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("GradoId,Grado1")] Grado1 grado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GradoId,Grado1")] Grado1 grado)
        {
            if (id != grado.GradoId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Grado1'  is null.");
            }
            var grado = await _context.Grado.FindAsync(id);
            if (grado != null)
            {
        ...
        {
          return (_context.Grado?.Any(e => e.GradoId == id)).GetValueOrDefault();
        }
    }
}
